...
2. **DSP High-Gain Amp Modeler & Preset Audition Studio**: Modelagem física de amplificadores valvulados (Mesa Dual Rectifier, Peavey 5150 / 6505+, ENGL Fireball, Marshall JCM800, Fender Clean), TS9 Tube Screamer Overdrive, Noise Gate cirúrgico, EQ paramétrico de 5 bandas, Stereo Chorus, Ping-Pong Delay e Reverb de Convolução. Inclui **filtragem categórica (High-Gain, Clean, Experimental, Custom)**, **audition em tempo real ao passar o mouse (Hover Sample Preview)** e **insights de uso em cada preset (contador de 'times played', timestamp relativo 'last used' e ordenação por mais tocados/recentes)**.
