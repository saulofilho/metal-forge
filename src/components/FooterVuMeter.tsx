  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        {/* Right Real-time Audio Amplitude VU Meter with Subtle CSS Pulse */}
        <div className="flex items-center gap-4 sm:gap-5 w-full lg:w-auto justify-end">
          ...
          {isLiveInputActive && (
            <div className="hidden sm:flex items-center gap-2">
              ...
              <div className="h-3 w-16 bg-[#0A0A0B] rounded-sm relative overflow-hidden border border-[#222226]">
                <div
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1.5 text-gray-400">
              ...
              <span className="text-[9px] uppercase tracking-widest text-gray-400 font-bold">MASTER OUT</span>
            </div>
            ...
            <div
              ...
              style={pulseStyle}
              className={`h-4 w-44 sm:w-56 bg-[#0A0A0B] rounded-md relative overflow-hidden border transition-all duration-100 flex items-center p-0.5 ${
                isClipping
                  ? "border-red-500"
                  : isSignalActive
                  ? "border-[#CCFF00]/60"
            ...
            {/* Numeric dB Readout */}
            <div
              className={`min-w-[64px] text-right font-mono text-xs font-bold transition-colors ${
                isMuted
                  ? "text-red-400"
                  : isClipping
